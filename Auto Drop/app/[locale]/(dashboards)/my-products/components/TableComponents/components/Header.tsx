...
export default function Header({
  ...
  const {SuccessComponent:SuccessComponent}  = useSuccessToast({title:"Success",description:"Products has been linked successfully.",successButtonRef:successButtonRef})
  const { ProfitComponent, LoaderComponent } = useProfitTypeHandler({
    upProducts,
    val,
    percentage,
    profitType,
    number,errorButtonRefNoSelection,errorButtonRefNoToken,errorButtonRefSubmitError,successButtonRef
  });
  return (
    <>
      {/* {LoaderComponent} */}

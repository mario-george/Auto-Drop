...
export default function HoverCardWrapper({
  ...
  let content =     <div className="hidden lap:flex flex-col min-w-[40rem] font-bold text-[24px] ">
...
let mobileContent= <div className="flex lap:hidden relative z-[10000] flex-col !min-w-[10rem] font-bold text-sm " dir={`${locale == "ar" ? "rtl" : "ltr"}`}>
...
<div className="grid grid-rows-2 gap-3">
  ...
  <div className="bg-[#eaebec] flex flex-1 justify-between font-normal text-xs rounded-lg -my-5 py-2 -mx-4 mt-2 px-2">
    ...
    <div>{subscriptionExpirationDate} 
    </div>
